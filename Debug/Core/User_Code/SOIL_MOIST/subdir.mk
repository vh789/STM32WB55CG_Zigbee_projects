...
C_SRCS += \
../Core/User_Code/SOIL_MOIST/SOIL_MOIST.c 

OBJS += \
./Core/User_Code/SOIL_MOIST/SOIL_MOIST.o 

C_DEPS += \
./Core/User_Code/SOIL_MOIST/SOIL_MOIST.d 


# Each subdirectory must supply rules for building sources it contributes
Core/User_Code/SOIL_MOIST/%.o Core/User_Code/SOIL_MOIST/%.su Core/User_Code/SOIL_MOIST/%.cyclo: ../Core/User_Code/SOIL_MOIST/%.c Core/User_Code/SOIL_MOIST/subdir.mk
...
clean: clean-Core-2f-User_Code-2f-SOIL_MOIST

clean-Core-2f-User_Code-2f-SOIL_MOIST:
	-$(RM) ./Core/User_Code/SOIL_MOIST/SOIL_MOIST.cyclo ./Core/User_Code/SOIL_MOIST/SOIL_MOIST.d ./Core/User_Code/SOIL_MOIST/SOIL_MOIST.o ./Core/User_Code/SOIL_MOIST/SOIL_MOIST.su

.PHONY: clean-Core-2f-User_Code-2f-SOIL_MOIST
