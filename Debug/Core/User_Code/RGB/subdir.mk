...
C_SRCS += \
../Core/User_Code/RGB/RGB.c 

OBJS += \
./Core/User_Code/RGB/RGB.o 

C_DEPS += \
./Core/User_Code/RGB/RGB.d 


# Each subdirectory must supply rules for building sources it contributes
Core/User_Code/RGB/%.o Core/User_Code/RGB/%.su Core/User_Code/RGB/%.cyclo: ../Core/User_Code/RGB/%.c Core/User_Code/RGB/subdir.mk
...
clean: clean-Core-2f-User_Code-2f-RGB

clean-Core-2f-User_Code-2f-RGB:
	-$(RM) ./Core/User_Code/RGB/RGB.cyclo ./Core/User_Code/RGB/RGB.d ./Core/User_Code/RGB/RGB.o ./Core/User_Code/RGB/RGB.su

.PHONY: clean-Core-2f-User_Code-2f-RGB
