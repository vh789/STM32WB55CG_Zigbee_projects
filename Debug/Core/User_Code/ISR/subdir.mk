...
C_SRCS += \
../Core/User_Code/ISR/isr.c 

OBJS += \
./Core/User_Code/ISR/isr.o 

C_DEPS += \
./Core/User_Code/ISR/isr.d 


# Each subdirectory must supply rules for building sources it contributes
Core/User_Code/ISR/%.o Core/User_Code/ISR/%.su Core/User_Code/ISR/%.cyclo: ../Core/User_Code/ISR/%.c Core/User_Code/ISR/subdir.mk
...
clean: clean-Core-2f-User_Code-2f-ISR

clean-Core-2f-User_Code-2f-ISR:
	-$(RM) ./Core/User_Code/ISR/isr.cyclo ./Core/User_Code/ISR/isr.d ./Core/User_Code/ISR/isr.o ./Core/User_Code/ISR/isr.su

.PHONY: clean-Core-2f-User_Code-2f-ISR
